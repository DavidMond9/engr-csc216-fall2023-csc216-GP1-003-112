...
public class Course {
	...
	/**
	 * Converts military time to regular time and gets the meeting string of meeting days, start time, and end time.
	 * @return the meeting string which consists of meeting days, start time, and end time.
	 */
	public String getMeetingString() {
		...
		//Check to see if the starting or ending times have a leading 0, adjust res accordingly
		if(extraZeroStart || extraZeroEnd) {
			if(extraZeroEnd && extraZeroStart) {
				res += meet + " " + startHour + ":" + "0" + startMin + startTimer + "-" + endHour + ":" + "0" + endMin + endTimer;
			}
			else if(extraZeroStart) {
				res += meet + " " + startHour + ":" + "0" + startMin + startTimer + "-" + endHour + ":"  + endMin + endTimer;
			}
			else {
				res += meet + " " + startHour + ":" + startMin + startTimer + "-" + endHour + ":" + "0" + endMin + endTimer;
			}
		}
		else {
